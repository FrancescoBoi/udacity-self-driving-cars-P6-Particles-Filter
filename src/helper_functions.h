...
/**
 * Computes a multi-variate Gaussian probability.
 * @param (x_obs,y_obs) x and y map coordinates of observation point
 * @param (mu_x, mu_y) x and y map coordinates of landmark positions
 * @param (std_x) x standard deviation
 * @param (std_y) y standard deviation 
 * @output Gaussian multivariate probability
 */
